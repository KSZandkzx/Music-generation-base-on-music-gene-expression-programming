...
if __name__ == '__main__':
    X = []
    for n in range(80):
        rad = "./trainset/zhoujielun/" + "zhuge/" + str(n).zfill(5) + "zhuge.fft.npy"
        # 一个声音文件的0-1000的频率
    ...
    # model = load_model('my_modelzhuge.h5')
    ...
    model.save('my_modelzhuge.h5')
    # 预测
    mymodel = load_model('my_modelzhuge.h5')
    # mymodel = model
    # type_index = mymodel.predict(X_test)
    # print(type_index)
